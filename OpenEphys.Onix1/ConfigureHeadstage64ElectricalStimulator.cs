...
namespace OpenEphys.Onix1
{
    ...
    static class Headstage64ElectricalStimulator
    {
        ...
        /// 刺激通道1参数配置
        /// </summary>
        public const uint CH1PULSEDUR1 = 0;  // 单位us, 比如UI上填了10，那就相当于下发了10us(物理有个最小限制25us)
        ...
        public const uint CH1CURRENT1 = 6;  // 阻抗检测时，通道输出电流复用此寄存器
        public const uint CH1CURRENT2 = 7;  // 单位mA，负数要转换成正数，需要转换公式
