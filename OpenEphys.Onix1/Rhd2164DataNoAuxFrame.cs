...
namespace OpenEphys.Onix1
{
    ...
    public class Rhd2164DataFrameNoAux : BufferedDataFrame
    {
        ...
        public Rhd2164DataFrameNoAux(ulong[] clock, ulong[] hubClock, Mat amplifierData, float r1, float r2)
            : base(clock, hubClock)
        {
    ...
    unsafe struct Rhd2164NoAuxPayload
    {
        ...
        public fixed int AmplifierData[Rhd2164NoAux.AmplifierChannelCount];
        public fixed int ImpedanceData[Rhd2164NoAux.ImpedanceChannelCount];
    }
}
